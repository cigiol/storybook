...
module.exports = {
  ...
  theme: {
    ...
    boxShadow: {
      'design-sm': '0px 0px 1px rgba(20, 20, 20, 0.04), 0px 0px 8px rgba(20, 20, 20, 0.08)',
      'design-md': '0px 0px 1px rgba(20, 20, 20, 0.08), 0px 1px 8px 2px rgba(20, 20, 20, 0.08)',
      'design-lg': '0px 0px 1px rgba(20, 20, 20, 0.08), 0px 1px 24px 8px rgba(20, 20, 20, 0.08)',
      'design-alt': '0px 3px 6px 2px rgba(102, 102, 102, 0.2)',
      'design-tutorial': '0px 4px 4px rgba(0, 0, 0, 0.25), 0px 4px 45px rgba(0, 0, 0, 0.25)',
      none: 'none',
    },
    extend: {
      spacing: {
